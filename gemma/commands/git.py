...
# Importing this command module no longer pulls the chat backend or
# cache layer in at module load — they fire on first call. Tests that
# patch ``gemma.commands.git.client_chat`` keep working because the
# name still exists on the module.
